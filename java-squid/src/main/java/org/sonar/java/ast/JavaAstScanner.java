...
public class JavaAstScanner {
  ...
  public static void scanSingleFileForTests(File file, VisitorsBridge visitorsBridge, JavaConfiguration conf) {
    ...
    if (visitorsBridge.getScannedFiles() != 1) {
      throw new IllegalStateException("Only one SourceFile was expected whereas " + visitorsBridge.getScannedFiles() + " has been returned.");
    }
  }
